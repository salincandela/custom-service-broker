...
public class CustomServiceInstanceBindingService implements ServiceInstanceBindingService {
	...
	public CustomServiceInstanceBindingService(ServiceBindingRepository bindingRepository,
	...
	private User createUser(CreateServiceInstanceBindingRequest request) {
		return userService.createUser(request.getBindingId(),
				FULL_ACCESS, CUSTOM_SERVICE_ID_PREFIX + request.getServiceInstanceId());
	}
