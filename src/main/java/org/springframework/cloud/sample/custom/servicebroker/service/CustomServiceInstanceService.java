...
public class CustomServiceInstanceService implements ServiceInstanceService {
	private final CustomService storeService;
	private final ServiceInstanceRepository instanceRepository;

	public CustomServiceInstanceService(CustomService storeService, ServiceInstanceRepository instanceRepository) {
	...
	public CreateServiceInstanceResponse createServiceInstance(CreateServiceInstanceRequest request) {
		...
		if (instanceRepository.existsById(instanceId)) {
			...
			storeService.createCustom(instanceId);
	...
	public DeleteServiceInstanceResponse deleteServiceInstance(DeleteServiceInstanceRequest request) {
		...
		if (instanceRepository.existsById(instanceId)) {
			storeService.deleteCustom(instanceId);
