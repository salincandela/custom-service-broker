...
package org.springframework.cloud.sample.custom.servicebroker.service;

import org.junit.Before;
import org.junit.Test;
import org.mockito.ArgumentCaptor;
import org.mockito.Mock;
import org.springframework.cloud.sample.custom.web.model.ApplicationInformation;
import org.springframework.cloud.sample.custom.servicebroker.model.ServiceBinding;
import org.springframework.cloud.sample.custom.servicebroker.repository.ServiceBindingRepository;
import org.springframework.cloud.sample.custom.web.model.User;
import org.springframework.cloud.sample.custom.web.service.UserService;
...
import static org.springframework.cloud.sample.custom.web.security.SecurityAuthorities.CUSTOM_SERVICE_ID_PREFIX;
import static org.springframework.cloud.sample.custom.web.security.SecurityAuthorities.FULL_ACCESS;

public class CustomServiceInstanceBindingServiceTests {
	...
	private CustomServiceInstanceBindingService service;
	...
	public void setUp() {
		...
		service = new CustomServiceInstanceBindingService(repository, userService, appInfo);
	}
	...
	public void createBindingWhenBindingDoesNotExist() {
		...
		when(userService.createUser(SERVICE_BINDING_ID, FULL_ACCESS, CUSTOM_SERVICE_ID_PREFIX + SERVICE_INSTANCE_ID))
			.thenReturn(new User(SERVICE_BINDING_ID, "password", FULL_ACCESS, CUSTOM_SERVICE_ID_PREFIX + SERVICE_INSTANCE_ID));
		...
		assertThat(credentials.get("uri").toString())
			.startsWith(BASE_URL)
			.endsWith("custom/" + SERVICE_INSTANCE_ID);
