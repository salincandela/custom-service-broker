...
import org.springframework.cloud.sample.custom.servicebroker.model.ServiceInstance;
import org.springframework.cloud.sample.custom.servicebroker.repository.ServiceInstanceRepository;
import org.springframework.cloud.sample.custom.web.service.CustomService;
...
public class CustomServiceInstanceServiceTests {
	private static final String SERVICE_INSTANCE_ID = "instance-id";

	@Mock
	private CustomService store;

	@Mock
	private ServiceInstanceRepository repository;

	private CustomServiceInstanceService service;

	@Before
	public void setUp() {
		initMocks(this);

		service = new CustomServiceInstanceService(store, repository);
	}
	...
	public void createServiceInstanceWhenInstanceDoesNotExist() {
		...
		verify(store).createCustom(SERVICE_INSTANCE_ID);
	...
	public void deleteServiceInstanceWhenInstanceExists() {
		...
		verify(store).deleteCustom(SERVICE_INSTANCE_ID);
		verifyNoMoreInteractions(store);
	}
